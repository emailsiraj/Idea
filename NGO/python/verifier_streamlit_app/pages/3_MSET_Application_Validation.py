...
"student_signature":(423, 649, 583, 670),
"guardian_signature":(406, 670, 555, 706),
}
...
if "verified_aadhar" not in st.session_state or "verified_face" not in st.session_state or "verified_income" not in st.session_state:
    st.error(" You cannot access this page yet.")
    st.stop()
elif st.session_state.verified_aadhar == False or st.session_state.verified_face == False or st.session_state.verified_income == False:
    st.error(" You cannot access this page yet.")
    st.stop()

if "verified_mset" not in st.session_state:
    st.session_state.verified_mset = False
    
if st.session_state.verified_mset:
    ...
    if uploaded:
        ...
        if pts is not None: 
            ...
            if len(missing_value_list) != 0:
                ...
                st.session_state.verified_mset = True
