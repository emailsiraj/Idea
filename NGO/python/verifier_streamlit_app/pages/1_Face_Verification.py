...
# Function to detect grayscale images (basic, might need modification)
...
def reset_session_state():
    st.session_state.status['verified_face'] = False
    
# If face already verified previously → show success & skip processing
if st.session_state.status['verified_face']:
    ...
    if uploaded_face:
        ...
        try:
            ...
            if not is_valid:
                ...
                url = upload_cv2_image_to_s3(cv2.cvtColor(img, cv2.COLOR_RGB2BGR), 
